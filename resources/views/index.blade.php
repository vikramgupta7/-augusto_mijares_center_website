...
<body>
	...
	<div class="container">
		<div class="grid" id="page_index_grid1">
			<div class="box left">
				<img src="images/logo.png" alt="Augusto Mijares Center">
				<p>
					<h1 class="blue_text rajdhani">CENTRO AUGUSTO MIJARES​</h1>
					<h2 class="rajdhani">DESARROLLO HUMANO SUSTENTABLE</h2>
				</p>
			</div>
		...
		<div class="box purple">	
			<div class="grid" id="page_index_grid1">
				<div>		
					<p>
						<iframe src="https://www.youtube.com/embed/Kcl-T98Wtvo" width="420" height="315"></iframe>
					</p>
				</div>

				<div class="left_list">
					<h2 class="left">OBJETIVOS</h2>
					<p>
						<ol class="text">
